...
def main():
    ...
    # Créez votre figure et vos axes explicitement
    fig, ax = plt.subplots()
    # Utilisez plt.pie() pour créer le diagramme circulaire sur les axes
   # Remplacez cela par vos données réelles
    ax.pie(targets, explode=[0, 0.1], labels=["Solvable", "Non solvable"], autopct='%1.1f%%',
       shadow=True, startangle=90)
    # Affichez la figure dans la barre latérale de Streamlit en passant la figure comme argument à st.pyplot()
